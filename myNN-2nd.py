...
y = original_train_y[idx] 

X = original_train_x[idx]/255
X = np.reshape(X, (26344,12288))

num_examples = len(X) # training set size
nn_input_dim = 12288 # input layer dimensionality
nn_output_dim = 40 # output layer dimensionality
